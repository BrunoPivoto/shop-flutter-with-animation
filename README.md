...
O projeto possui autentificação com produtos favoritos e pedidos para cada usuário, animações e navegação, alémd e uma conxeão com o Real Time Database da Firebase da Google.
